...
let rtx = `*❀ KoharuJadiBot ❀*\nㅤㅤㅤㅤ*Ser sub bot*\n\n*Con otro telefono que tengas o en la PC escanea este QR para convertirte en un sub bot*\n\n*1. Haga clic en los tres puntos en la esquina superior derecha*\n*2. Toca WhatsApp Web*\n*3. Escanee este codigo QR*\n*Este código QR expira en 45 segundos!*\n\n> *⚠️ No nos hacemos responsable del mal uso que se le pueda dar o si el numero se manda a soporte.. ustedes tienen el deber se seguir al pie de la letra los terminos y condiciones y privacidad (escribe eso y te los dará)*`
let rtx2 = `❀ *_NUEVA FUNCIÓN DE HACERTE UN SUB BOT_* ❀

*1️⃣ Paso uno:* Dirígete a los tres puntitos mágicos en la esquinita superior derecha  
*2️⃣ Paso dos:* Toca la opción que dice "Dispositivos vinculados"  
*3️⃣ Paso tres:* Elige "Vincular con código de teléfono"  
*4️⃣ Paso cuatro:* Pega el código que te daremos justo aquí abajito~  

> ❀ *Notita importante:* No nos hacemos responsables por el uso incorrecto del bot o si el número termina en soporte...  
Tú eres el guardiancito de tu bot, así que sigue con cariño los Términos, Condiciones y Políticas de Privacidad (escribe eso y te los dará).`
...
msgRetry,
msgRetryCache,
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['KoharuBot-MD (Sub Bot)', 'Chrome','2.0.0'],
version: version,
...
if (options.fromCommand) m?.chat ? await conn.sendMessage(m.chat, {text : '*❀ HEMOS DETECTADO UNA NUEVA SESIÓN, BORRE LA NUEVA SESIÓN PARA CONTINUAR*\n\n> *SI HAY ALGÚN PROBLEMA VUELVA A CONECTARSE*' }, { quoted: m || null }) : ""
}
...
m?.chat ? await conn.sendMessage(m.chat, {text : args[0] ? `❀ Yatta~ ¡Conexión completita! Por favor espera un poquito... los mensajitos mágicos están cargándose~ *` : `* Conexión con WhatsApp establecida exitosamente ❀
