...
if (m.money) m.reply(+m.money + ` yenes ${await tr("usados")} 🪙`) 
}
break
}}} catch (e) {
console.error(e)
...
if (!m.fromMem && m.text.match(/(@59169081575|Bot|Botsito|Gata|:v)/gi)) {
...
if (media === 'texto') {
this.sendMessage(id, { text: text, contextInfo: { forwardedNewsletterMessageInfo: { newsletterJid: '120363198641161536@newsletter', serverMessageId: '', newsletterName: '✿ kօհαɾմ հíժαkα թօաҽɾҽժ @Alba070503 ✿' }, forwardingScore: 9999999, isForwarded: true, mentionedJid: [user], externalAdReply: { showAdAttribution: true, renderLargerThumbnail: true, thumbnail: apii.data, title: [wm, ' ' + wm + '✿'].getRandom(), containsAutoReply: true, mediaType: 1, sourceUrl: [nna, nna2, nnntt, yt].getRandom() } } }, { quoted: fkontak2 });
}
if (media === 'audio') {
this.sendMessage(id, { audio: { url: vn }, contextInfo: { forwardedNewsletterMessageInfo: { newsletterJid: '120363198641161536@newsletter', serverMessageId: '', newsletterName: '✿ kօհαɾմ հí́ժαkα թօաҽɾҽժ @αlճα070503 ✿' }, forwardingScore: 9999999, isForwarded: true, mentionedJid: [user], externalAdReply: { mediaType: 1, previewType: "PHOTO", thumbnail: apii.data, title: `✿ Kon'nichiwa ✿`, body: [wm, ' ' + wm + '✿'].getRandom(), showAdAttribution: true, renderLargerThumbnail: true, sourceUrl: [nna, nna2, nnntt, yt].getRandom() } }, ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp3` }, { quoted: fkontak2 });
}}}}
